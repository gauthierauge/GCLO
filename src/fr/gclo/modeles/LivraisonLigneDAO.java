...
public class LivraisonLigneDAO {
...
//    			     "WHERE IDLivraison      =  " + Livraison.getIDLivraison(); 
	...
	public Livraison read(String ID) {
		...
		Livraison Livraison = null;
	     ...
	     ResultSet rs =  DataBaseInstance.executeQuery("SELECT codeLivraison FROM Livraison__tbl WHERE CodeLivraison = '" + ID + "'");
//	     try {
//		     //if ( rs.next() ) 
...
//	     }
    ...
    public static String getSQLFicheLivraison(String ID) {
    	
		return "SELECT CompteurLivraisonLigne AS COMPTEUR, CodeLivraison AS NUMERO, CodeArticle AS CODE_REF, CodeArticle AS CODE_REF, DesignationArticle AS ARTICLE FROM LivraisonLigne__tbl WHERE CodeLivraison = '" + ID + "'";
	}
    
    public static String getSQL() {
    	
		return "SELECT CompteurLivraisonLigne AS COMPTEUR, CodeLivraison AS NUMERO, FROM LivraisonLigne__tbl";
	}
